...
public:
    void setZeroes(vector<vector<int> > &matrix) 
    {
        ...
        bool fc0 = false; // record flag of the first col
        bool fr0 = false; // record flag of the first row
        ...
        // check the rest of the matrix, except the first row and first col, so begin from 1
        // mark at the 0th position
        for (int i = 1; i < row; i++)
        {
            for (int j = 1; j < col; j++)
            {
